...
class Point(object):
    ...
    """
    def __init__(self, unit=None, x=None, y=None):
        """
    ...
    def unit(self):
        """
        Gets the unit of this Point.
        The unit (pt)

        :return: The unit of this Point.
        :rtype: str
        """
        return self._unit
    ...
    def unit(self, unit):
        """
        Sets the unit of this Point.
        The unit (pt)

        :param unit: The unit of this Point.
        :type: str
        """
        allowed_values = ["pt"]
